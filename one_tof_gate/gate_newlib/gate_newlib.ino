...
int mInterval = 200; //refresh rate of 10hz
...
void setup(void)
{
  ...
  else
  {
    ...
    sensor_A.setMeasurementTimingBudget(140000); //Set its timing budget in microseconds longer timing budgets will give more accurate measurements
  ...
  else
  {
    ...
    sensor_B.setMeasurementTimingBudget(140000); //Set its timing budget in microseconds longer timing budgets will give more accurate measurements
