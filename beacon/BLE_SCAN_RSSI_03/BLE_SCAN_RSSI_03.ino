...
#define MQTT_USERNAME "esp32_ble0003"
#define MQTT_PASSWORD "123456"
#define MQTT_NAME "esp32_ble0003"
...
void setup()
{
  ...
  Serial.println("Beacon station -3 , Version 1.1 (edit retain msg )");
  ...
  for (;;)
  {
    ...
    if (mqtt.connected() == false)
    {
      ...
      if (mqtt.connect(MQTT_NAME))
      {
        ...
        mqtt.subscribe("Lk3ya3cv/ble/station/3");
        mqtt.publish("Lk3ya3cv/ble/station/3", "start");
      }
      else
      {
